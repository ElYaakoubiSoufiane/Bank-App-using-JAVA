...
public class MyJDBC {
    ...
    private static final String DB_URL = "jdbc:mysql://127.0.0.1:3306/banckschema";
    private static final String DB_USERNAME = "root";
    private static final String DB_PASSWORD = "0603763373";
    ...
    public static boolean updateCurrentBalance(User user){
        try{
            ...
            PreparedStatement updateBalance = connection.prepareStatement(
                    "UPDATE users SET currentBalance = ? WHERE user_id = ?"
            );
